...
A **specific** configuration of CentOS that will hopefully provide the base Linux server platform for most things I (Mason) need to do on Linux. 

> Mason Linux == CentOS 7 + software + configuration
